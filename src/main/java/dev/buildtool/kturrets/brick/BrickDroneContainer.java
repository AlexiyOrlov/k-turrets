...
public class BrickDroneContainer extends Container2 {
    public BrickDroneContainer(int i, Inventory playerInventory, FriendlyByteBuf buffer) {
        ...
        addSlot(new ItemHandlerSlot(brickDrone.upgrades,0,2*18,2*18).setColor(KTurrets.upgradeSlotColor).setTooltip(Component.translatable("k_turrets.upgrade.slot")));
        addSlot(new ItemHandlerSlot(brickDrone.upgrades,1,3*18,2*18).setColor(KTurrets.upgradeSlotColor).setTooltip(Component.translatable("k_turrets.upgrade.slot")));
        addSlot(new ItemHandlerSlot(brickDrone.upgrades, 2,4*18,2*18).setColor(KTurrets.upgradeSlotColor).setTooltip(Component.translatable("k_turrets.upgrade.slot")));
        addSlot(new ItemHandlerSlot(brickDrone.upgrades, 3,5*18,2*18).setColor(KTurrets.upgradeSlotColor).setTooltip(Component.translatable("k_turrets.upgrade.slot")));
        addSlot(new ItemHandlerSlot(brickDrone.upgrades, 4,6*18,2*18).setColor(KTurrets.upgradeSlotColor).setTooltip(Component.translatable("k_turrets.upgrade.slot")));
