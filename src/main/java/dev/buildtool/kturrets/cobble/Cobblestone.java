...
public class Cobblestone extends PresetProjectile {
    public Cobblestone(Level p_i50173_2_) {
        super(KEntities.COBBLESTONE.get(), p_i50173_2_);
    }
    ...
    protected DamageSource getDamageSource() {
        return damageSources().mobProjectile(this, (LivingEntity) getOwner());//new IndirectDamageSource("k_turrets.cobblestone", this, getOwner());
    }
