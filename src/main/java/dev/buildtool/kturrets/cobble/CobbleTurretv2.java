...
public class CobbleTurretv2 extends EntityModel<CobbleTurret> {
    ...
    public CobbleTurretv2() {
        ...
        cube_r1.setPos(3.0F, -10.5F, 1.0F);
        rotating.addChild(cube_r1);
        setRotationAngle(cube_r1, 0.0F, 0.0F, 0.1745F);
        cube_r1.texOffs(0, 9).addBox(-2.0F, 0.5F, -3.0F, 4.0F, 1.0F, 7.0F, 0.0F, false);

        cube_r2 = new ModelRenderer(this);
        cube_r2.setPos(-3.0F, -10.5F, 1.0F);
        rotating.addChild(cube_r2);
        setRotationAngle(cube_r2, 0.0F, 0.0F, -0.1745F);
        cube_r2.texOffs(15, 10).addBox(-2.0F, 0.5F, -3.0F, 4.0F, 1.0F, 7.0F, 0.0F, false);
