package dev.buildtool.kturrets.cobble;// Made with Blockbench 4.2.2
...
public class CobbleTurretv2<T extends Entity> extends EntityModel<T> {
    ...
    public CobbleTurretv2(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition rotating = partdefinition.addOrReplaceChild("rotating", CubeListBuilder.create().texOffs(0, 27).addBox(-1.0F, -4.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(22, 26).addBox(-1.0F, -10.0F, 0.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 20.0F, 0.0F));

        PartDefinition cube_r1 = rotating.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(0, 9).addBox(-2.0F, 0.5F, -3.0F, 4.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(3.0F, -10.5F, 1.0F, 0.0F, 0.0F, 0.1745F));

        PartDefinition cube_r2 = rotating.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(15, 10).addBox(-2.0F, 0.5F, -3.0F, 4.0F, 1.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, -10.5F, 1.0F, 0.0F, 0.0F, -0.1745F));
