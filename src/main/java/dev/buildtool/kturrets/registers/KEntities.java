...
public class KEntities {
    ...
    public static final RegistryObject<EntityType<FireballTurret>> FIRE_CHARGE_TURRET = ENTITIES.register("fire_charge_turret", () -> cast(EntityType.Builder.of((p_create_1_, p_create_2_) -> new FireballTurret(p_create_2_), MobCategory.MISC).sized(0.8f, 0.7f).build("fire_charge")));
