...
public class KEntities {
    ...
    public static void registerAttributes(EntityAttributeCreationEvent attributeCreationEvent) {
        ...
        attributeCreationEvent.put(FIRECHARGE_DRONE, Turret.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.CHARGE_TURRET_RANGE.get() - 5).add(Attributes.MAX_HEALTH, KTurrets.CHARGE_TURRET_HEALTH.get() * 0.83).add(Attributes.ARMOR, KTurrets.CHARGE_TURRET_ARMOR.get() * 0.34).build());
