...
public class KEntities {
    ...
    public static final EntityType<FireballTurret> FIRE_CHARGE_TURRET = cast(EntityType.Builder.of((p_create_1_, p_create_2_) -> new FireballTurret(p_create_2_), EntityClassification.MISC).sized(0.8f, 0.7f).fireImmune().build("fire_charge"));
    ...
    public static void registerAttributes(EntityAttributeCreationEvent attributeCreationEvent) {
        ...
        attributeCreationEvent.put(COBBLE_DRONE, Turret.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.COBBLE_TURRET_RANGE.get() - 5).add(Attributes.MAX_HEALTH, KTurrets.COBBLE_TURRET_HEALTH.get() * 0.85).add(Attributes.ARMOR, KTurrets.COBBLE_TURRET_ARMOR.get() * 0.34).build());
        attributeCreationEvent.put(ARROW_DRONE, Turret.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.ARROW_TURRET_RANGE.get() - 5).add(Attributes.MAX_HEALTH, KTurrets.ARROW_TURRET_HEALTH.get() * 0.85).add(Attributes.ARMOR, KTurrets.ARROW_TURRET_ARMOR.get() * 0.34).build());
        attributeCreationEvent.put(BULLET_DRONE, Turret.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.BULLET_TURRET_RANGE.get() - 5).add(Attributes.MAX_HEALTH, KTurrets.BULLET_TURRET_HEALTH.get() * 0.85).add(Attributes.ARMOR, KTurrets.BULLET_TURRET_ARMOR.get() * 0.34).build());
        attributeCreationEvent.put(FIRECHARGE_DRONE, Turret.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.CHARGE_TURRET_RANGE.get() - 5).add(Attributes.MAX_HEALTH, KTurrets.CHARGE_TURRET_HEALTH.get() * 0.85).add(Attributes.ARMOR, KTurrets.CHARGE_TURRET_ARMOR.get() * 0.34).build());
        attributeCreationEvent.put(BRICK_DRONE, Turret.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.BRICK_TURRET_RANGE.get() - 5).add(Attributes.MAX_HEALTH, KTurrets.BRICK_TURRET_HEALTH.get() * 0.85).add(Attributes.ARMOR, KTurrets.BRICK_TURRET_ARMOR.get() * 0.34).build());
        attributeCreationEvent.put(GAUSS_DRONE, Turret.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.GAUSS_TURRET_RANGE.get() - 5).add(Attributes.MAX_HEALTH, KTurrets.GAUSS_TURRET_HEALTH.get() * 0.85).add(Attributes.ARMOR, KTurrets.GAUSS_TURRET_ARMOR.get() * 0.34).build());
    }
}
