...
public class TEntities {
    ...
    public static final EntityType<FireChargeTurret> FIRE_CHARGE_TURRET = cast(EntityType.Builder.of((p_create_1_, p_create_2_) -> new FireChargeTurret(p_create_2_), EntityClassification.MISC).sized(0.8f, 0.7f).fireImmune().build("fire_charge"));
