...
public class TEntities {
    ...
    public static final RegistryObject<EntityType<FireChargeTurret>> FIRE_CHARGE_TURRET = ENTITIES.register("fire_charge_turret", () -> cast(EntityType.Builder.of((p_create_1_, p_create_2_) -> new FireChargeTurret(p_create_2_), MobCategory.MISC).sized(0.8f, 0.7f).fireImmune().build("fire_charge")));
    ...
    public static final RegistryObject<EntityType<FirechargeDrone>> FIRECHARGE_DRONE = ENTITIES.register("firecharge_drone", () -> cast(EntityType.Builder.of((p_20722_, p_20723_) -> new FirechargeDrone(p_20723_), MobCategory.MISC).sized(DRONE_WIDTH, DRONE_WIDTH).fireImmune().build("firecharge_drone")));
