...
public class TEntities {
    ...
    public static final RegistryObject<EntityType<FirechargeDrone>> FIRECHARGE_DRONE = ENTITIES.register("firecharge_drone", () -> cast(EntityType.Builder.of((p_20722_, p_20723_) -> new FirechargeDrone(p_20723_), MobCategory.MISC).sized(DRONE_WIDTH, DRONE_WIDTH).build("firecharge_drone")));
