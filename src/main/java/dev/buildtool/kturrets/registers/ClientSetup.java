...
public class ClientSetup {
    ...
    public static void registerRenderers(EntityRenderersEvent.RegisterRenderers renderers) {
        ...
        renderers.registerEntityRenderer(TEntities.FIRE_CHARGE_TURRET.get(), manager -> new EntityRenderer2<>(manager, new FireballTurretModelv4<>(manager.bakeLayer(FireballTurretModelv4.LAYER_LOCATION)), "fireball_turret", false, 0.3f));
