...
public class EntityAttributes {
    ...
    public static void registerAttributes(EntityAttributeCreationEvent attributeCreationEvent) {
        ...
        attributeCreationEvent.put(KEntities.FIRE_CHARGE_TURRET.get(), Turret.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.FIREBALL_TURRET_RANGE.get()).add(Attributes.MAX_HEALTH, KTurrets.FIREBALL_TURRET_HEALTH.get()).add(Attributes.ARMOR, KTurrets.FIREBALL_TURRET_ARMOR.get()).build());
