...
public class EntityAttributes {
    ...
    public static void registerAttributes(EntityAttributeCreationEvent attributeCreationEvent) {
        ...
        attributeCreationEvent.put(TEntities.BRICK_DRONE.get(), Drone.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.BRICK_TURRET_RANGE.get() - 5).add(Attributes.MAX_HEALTH, Math.max(10, KTurrets.BRICK_TURRET_HEALTH.get() * 0.83)).add(Attributes.ARMOR, Math.max(0, KTurrets.BRICK_TURRET_ARMOR.get() * 0.34)).build());
        attributeCreationEvent.put(TEntities.BULLET_DRONE.get(), Drone.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.BULLET_TURRET_RANGE.get() - 5).add(Attributes.MAX_HEALTH, Math.max(10, KTurrets.BULLET_TURRET_HEALTH.get() * 0.83)).add(Attributes.ARMOR, Math.max(0, KTurrets.BULLET_TURRET_ARMOR.get() * 0.34)).build());
        attributeCreationEvent.put(TEntities.COBBLE_DRONE.get(), Drone.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.COBBLE_TURRET_RANGE.get() - 5).add(Attributes.MAX_HEALTH, Math.max(10, KTurrets.COBBLE_TURRET_HEALTH.get() * 0.83)).add(Attributes.ARMOR, Math.max(0, KTurrets.COBBLE_TURRET_ARMOR.get() * 0.34)).build());
        attributeCreationEvent.put(TEntities.ARROW_DRONE.get(), Drone.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.ARROW_TURRET_RANGE.get() - 5).add(Attributes.MAX_HEALTH, Math.max(10, KTurrets.ARROW_TURRET_HEALTH.get() * 0.83)).add(Attributes.ARMOR, Math.max(0, KTurrets.ARROW_TURRET_ARMOR.get() * 0.34)).build());
        attributeCreationEvent.put(TEntities.GAUSS_DRONE.get(), Drone.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.GAUSS_TURRET_RANGE.get() - 5).add(Attributes.MAX_HEALTH, Math.max(10, KTurrets.GAUSS_TURRET_HEALTH.get() * 0.83)).add(Attributes.ARMOR, Math.max(0, KTurrets.GAUSS_TURRET_ARMOR.get() * 0.34)).build());
        attributeCreationEvent.put(TEntities.FIRECHARGE_DRONE.get(), Drone.createDefaultAttributes().add(Attributes.FOLLOW_RANGE, KTurrets.CHARGE_TURRET_RANGE.get() - 5).add(Attributes.MAX_HEALTH, Math.max(10, KTurrets.CHARGE_TURRET_HEALTH.get() * 0.83)).add(Attributes.ARMOR, Math.max(0, KTurrets.CHARGE_TURRET_ARMOR.get() * 0.34)).build());
    }
}
