...
public class WorldGeneration {
    ...
    public static final RegistryObject<ConfiguredFeature<?, ?>> CONFIGURED_ORE_FEATURE = CONFIGURED_FEATURE_REGISTER.register("titanium_ore", () -> new ConfiguredFeature<>(Feature.ORE, new OreConfiguration(TARGET_BLOCKSTATES.get(), 5)));
    ...
    static {
        PLACED_FEATURE_REGISTER.register("titanium_ore", () -> new PlacedFeature(CONFIGURED_ORE_FEATURE.getHolder().get(), List.of(CountPlacement.of(4), InSquarePlacement.spread(), HeightRangePlacement.triangle(VerticalAnchor.bottom(), VerticalAnchor.absolute(384)))));
    }
}
