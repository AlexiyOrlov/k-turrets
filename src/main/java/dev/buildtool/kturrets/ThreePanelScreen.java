...
public abstract class ThreePanelScreen extends BaseScreen{
    ...
    protected final Panel mainPanel = this.createMainPanel();
    protected final Panel bottomPanel = new ThreePanelScreen.BottomPanel();
    protected final PanelScrollBar scrollBar;
    private boolean showBottomPanel = true;
    private boolean showCloseButton = false;

    protected ThreePanelScreen() {
    ...
    protected abstract Panel createMainPanel();
    ...
    protected Panel createTopPanel() {
        return new ThreePanelScreen.TopPanel();
    }
    ...
    private class BottomPanel extends Panel {
        private final Button buttonAccept = SimpleTextButton.accept(this, (mb) -> {
            ThreePanelScreen.this.doAccept();
        }, TextComponentUtils.hotkeyTooltip("⇧ + Enter"));
        private final Button buttonCancel = SimpleTextButton.cancel(this, (mb) -> {
           ThreePanelScreen.this.doCancel();
        }, TextComponentUtils.hotkeyTooltip("ESC"));

        public BottomPanel() {
            super(ThreePanelScreen.this);
        }
    ...
    protected class TopPanel extends Panel {
        ...
        public TopPanel() {
            super(ThreePanelScreen.this);
            this.closeButton = new SimpleButton(this, Component.translatable("gui.close"), Icons.CLOSE, (btn, mb) -> {
                ThreePanelScreen.this.doCancel();
            });
        }

        public void addWidgets() {
            if (ThreePanelScreen.this.showCloseButton) {
