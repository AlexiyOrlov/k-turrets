...
public class ArrowTurretv2 extends EntityModel<ArrowTurret> {
    ...
    public ArrowTurretv2() {
        ...
        rotating_base.texOffs(36, 27).addBox(3.0F, -13.0F, -1.0F, 2.0F, 10.0F, 2.0F, 0.0F, false);
        rotating_base.texOffs(27, 27).addBox(-5.0F, -13.0F, -1.0F, 2.0F, 10.0F, 2.0F, 0.0F, false);
