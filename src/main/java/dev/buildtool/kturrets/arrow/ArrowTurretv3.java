...
public class ArrowTurretv3<T extends Entity> extends EntityModel<T> {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition rotating_base = partdefinition.addOrReplaceChild("rotating_base", CubeListBuilder.create().texOffs(0, 14).addBox(-5.0F, -3.0F, -5.0F, 10.0F, 2.0F, 10.0F, new CubeDeformation(0.0F))
                .texOffs(36, 27).addBox(3.0F, -13.0F, -1.0F, 2.0F, 10.0F, 4.0F, new CubeDeformation(0.0F))
                .texOffs(27, 27).addBox(-5.0F, -13.0F, -1.0F, 2.0F, 10.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
        ...
        PartDefinition rotating_gun = rotating_base.addOrReplaceChild("rotating_gun", CubeListBuilder.create().texOffs(0, 5).addBox(1.0F, -1.0F, -0.5F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(0, 0).addBox(-1.0F, 1.0F, 3.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-3.0F, -1.0F, 3.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(1.0F, -1.0F, 3.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F))
                .texOffs(0, 0).addBox(-1.0F, -3.0F, 3.0F, 2.0F, 2.0F, 3.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -10.0F, -0.5F));
