...
public class GaussTurretModelv2 extends EntityModel<GaussTurret> {
    ...
    public GaussTurretModelv2() {
        ...
        turret_barrel.texOffs(28, 14).addBox(-1.0F, 0.0F, -12.0F, 2.0F, 2.0F, 5.0F, 0.0F, false);
    }
