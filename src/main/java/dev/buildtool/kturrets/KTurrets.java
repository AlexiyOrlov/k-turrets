...
public class KTurrets {
    ...
    public KTurrets() {
        ...
        ModLoadingContext.get().registerConfig(ModConfig.Type.COMMON, new ForgeConfigSpec.Builder().configure(builder -> {
            ...
            BULLET_TURRET_RATE = builder.comment("In ticks").defineInRange("Fire rate", 13, 10, 60);
            ...
            CHARGE_TURRET_RATE = builder.comment("In ticks").defineInRange("Fire rate", 13, 10, 60);
            ...
            BRICK_TURRET_RATE = builder.comment("In ticks").defineInRange("Fire rate", 13, 10, 60);
