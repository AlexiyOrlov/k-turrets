package dev.buildtool.kturrets.bullet;// Made with Blockbench 4.6.4
...
public class BulletTurretModelv4<T extends Entity> extends EntityModel<T> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(KTurrets.ID, "textures/entity/bullet_turret4.png"), "main");
    private final ModelPart bone;
    private final ModelPart rotating;
    private final ModelPart bb_main;
    private final ModelPart vertical;

    public BulletTurretModelv4(ModelPart root) {
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition cube_r1 = vertical.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(32, 9).addBox(-5.5F, -2.5F, 1.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F))
                .texOffs(32, 9).addBox(-0.5F, -2.5F, 1.5F, 1.0F, 5.0F, 1.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.5F, -6.5F, 0.5F, -0.829F, 0.0F, 0.0F));
