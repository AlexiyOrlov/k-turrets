...
public class BulletDroneContainer extends Container2 {
    ...
    public ItemStack quickMoveStack(Player playerIn, int index) {
        ...
        if (index > KTurrets.droneSlotCount) {
            if ((itemStack.is(KTurrets.BULLET_UNIT_AMMO_TAG1) || itemStack.is(KTurrets.BULLET_UNIT_AMMO_TAG2)) && !moveItemStackTo(itemStack, 0, KTurrets.droneSlotCount-KTurrets.droneUpgradeCount, false))
